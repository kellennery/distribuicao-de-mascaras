                            ...
                            <div class="row clearfix" id="boxListagem">
                                <div class="col-md-12 column">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Listagem de UOs</h3>
                                        </div>
                                        <div class="panel-body">						
                                        <!-- Listagem - INICIO -->
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-md-12 column">
                                                        <div class="form-group-sm col-xs-2 col-sm-2 col-md-2 col-lg-2 ">
                                                            <label for="filtroCodigo" class="control-label label-sm">Código:</label>
                                                            <input class="form-control input-sm" type="text" maxlength="50" value="" id="filtroCodigo" name="filtroCodigo"  />
                                                        </div>													
                                                        <div class="form-group-sm col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                                                            <label for="filtroSigla" class="control-label label-sm">Sigla:</label>
                                                            <input class="form-control input-sm" type="text" maxlength="50" value="" id="filtroSigla" name="filtroSigla"  />
                                                        </div>
                                                        <div class="form-group-sm col-xs-4 col-sm-4 col-md-4 col-lg-4" >
                                                            <label class="control-label label-sm" for="filtroDescricao">Descrição:</label>
														...
														<div class="form-group-sm col-xs-3 col-sm-3 col-md-3 col-lg-3 text-right" >
                                                            <button type="button" class="btn btn-default btn-filtro" id="bt_pesquisar" onclick="carregarLista(13);" ><span class="fa fa-search black"></span> Pesquisar</button>
                                                        </div>														
